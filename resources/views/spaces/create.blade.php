                    ...
                    <form method="POST" action="{{ route('spaces.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="type" name="type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="desk" {{ old('type') == 'desk' ? 'selected' : '' }}>Escritorio</option>
                                <option value="room" {{ old('type') == 'room' ? 'selected' : '' }}>Sala</option>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price_per_hour" class="block mt-1 w-full" type="number" step="0.01" name="price_per_hour" :value="old('price_per_hour')" required min="0" />
